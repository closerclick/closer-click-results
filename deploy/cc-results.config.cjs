// Ecosystem de PM2 para closer-click-results (referencia; en proxy2 vive como
...
//
// CD (cc-deploy-listener): git pull en ~/closer-click-results + `pm2 restart closer-click-results`.

module.exports = {
  apps: [{
    name: 'closer-click-results',
    cwd: process.env.HOME + '/closer-click-results/server',
    script: 'server.js',
    interpreter: 'node',
    autorestart: true,
    max_restarts: 20,
