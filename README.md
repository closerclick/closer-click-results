# closer-click-results

Relay de **resultados oficiales en vivo** del ecosistema CloserClick
(`results.closer.click`). Centraliza —en **un solo punto, del lado del
...
PM2 `closer-click-results` en `:8092`, detrás de nginx (`results.closer.click` +
...
```
Caddy termina TLS automático. Imagen multi-arch en `ghcr.io/closerclick/closer-click-results`.
...
[cc-deploy-listener]: https://github.com/closerclick/cc-deploy-listener
