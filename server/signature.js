...
// Sobres firmados {data, signature} del ecosistema CloserClick — IDÉNTICO al de
// closer-click-geo/reputation (copiado verbatim para interoperar). La identidad
// es una clave ECDSA P-256 (del vault id.closer.click) en JWK string embebida en
